              ...
              {[
                ...
                <div key={step.num} className="flex items-center">
                  ...
                  <div className="flex flex-col items-center">
                    <div
                      className={`relative flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-full font-bold text-lg transition-all duration-500 transform ${
                    ...
                    <span
                      className={`mt-3 text-xs sm:text-sm font-medium text-center transition-all ${
                        currentStep >= step.num
                          ? "text-orange-600"
                          : "text-gray-400"
                      }`}
                  ...
                  {index < 2 && (
                    <div className="px-4">
                      <div className="h-1 w-8 sm:w-16 bg-gray-200 rounded-full overflow-hidden">
                        <div
                ...
                <div className="text-center animate-fadeIn">
                  ...
                  <div className="w-full flex justify-center mb-8">
                    <div className="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-2xl p-6 border border-orange-200 shadow-md w-fit text-center">
                      ...
                      <ol className="space-y-3 text-sm text-gray-700 text-left">
              ...
              {currentStep === 3 && (
                <div className="text-center animate-fadeIn">
                  ...
                  <p className="text-gray-600 mb-8 text-lg max-w-2xl mx-auto">
                    Now explore the demo menu and experience how ApnaMenu
                    transforms dining
                  </p>
